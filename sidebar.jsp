...
<div class="sidebar" style="background-color: hsl(210 50% 15%); height: 100vh;width:350px">
    <div>
        <div class="container-fluid">
            <div class="row  p-3 pb-0" >
                <h2 style="color: #ffffff;font-family:arial;font-size:30px"> Barangay DRMS</h2>
            </div>
            
            <div class="row px-3 mt-3 mb-4" style="border-bottom:3px solid gray;padding-bottom:10px">
                <h3 style="color: white;font-family:arial"> Infrastructure Management</h3>
            </div>

            <ul style="list-style-type:none; padding-left:20px;gap: 10px">
                <li>
                    <a href="../ccinfom_project/infrastructure_core.jsp" style="color: white;text-decoration: none;font-size:21px">
                        ...
                        <span style="padding-left:10px">Infrastructure</span>
                    
                    </a>
                </li>
                <li>
                    <a href="../ccinfom_project/staff_core.jsp" style="color: white;text-decoration: none;font-size:21px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-person-badge-fill" viewBox="0 0 16 16">
                            <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2zm4.5 0a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1zM8 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6m5 2.755C12.146 12.825 10.623 12 8 12s-4.146.826-5 1.755V14a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1z"/>
                        </svg>
                        
                        <span style="padding-left:10px">Staff</span>
                    </a>
                    </li>
                <li>
                    <a href="../ccinfom_project/inventory_core.jsp" style="color: white;text-decoration: none;font-size:21px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-box" viewBox="0 0 16 16">
                ...
                <li>
                    <a href="../ccinfom_project/barangay_officials_core.jsp" style="color: white;text-decoration: none;font-size:21px">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
                    ...
                    <span style="padding-left:10px">Officials</span>
                    </a>
                    </li>
                <li>
                    <a href="../ccinfom_project/damage_recording.jsp" style="color: white;text-decoration: none;font-size:21px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4m.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2"/>
                          </svg>
                        
                    <span style="padding-left:10px">Damage Recording</span>
                    </a>
                </li>
                <li>
                    <a href="../ccinfom_project/damage_repair.jsp" style="color: white;text-decoration: none;font-size:21px">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-wrench-adjustable-circle-fill" viewBox="0 0 16 16">
